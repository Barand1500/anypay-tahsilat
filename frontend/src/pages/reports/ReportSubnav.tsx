...
import { REPORT_SUBNAV } from './mockStatistics';
...
export function ReportSubnav() {
  ...
  function placePill(instant: boolean) {
    ...
    const active = track.querySelector<HTMLElement>('a.is-report-tab-active');
    if (!active) {
  ...
  useLayoutEffect(() => {
    ...
    // DOM aktif class’ı yazdıktan sonra ölç
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              [
                ...
                isActive
                  ? 'is-report-tab-active text-white'
